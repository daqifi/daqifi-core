...
{
    [McpServerTool(Name = "get_server_info", UseStructuredContent = true)]
    ...
    [McpServerTool(Name = "discover_devices", UseStructuredContent = true)]
    ...
    public static Task<IReadOnlyList<DiscoveredDevice>> DiscoverDevices(
        DaqifiAgent agent,
        [Description("Discovery timeout in milliseconds (default 2000; clamped to 1000..30000). The floor covers the serial identify handshake on the slowest supported hosts (several candidate ports, uncached USB descriptor queries); a lower budget can return an empty list before a device could answer — indistinguishable from none being attached. Serial probing can return before the full timeout once probes settle; WiFi discovery listens for replies for the whole window regardless, so a wifi=true call (the default) generally takes close to the full budget either way.")] int timeoutMs = 2000,
    ...
    [McpServerTool(Name = "connect_device", UseStructuredContent = true)]
    ...
    [McpServerTool(Name = "disconnect_device", UseStructuredContent = true)]
    ...
    [McpServerTool(Name = "list_connected_devices", UseStructuredContent = true)]
    ...
    [McpServerTool(Name = "get_device_status", UseStructuredContent = true)]
    ...
    [McpServerTool(Name = "list_channels", UseStructuredContent = true)]
    ...
    [McpServerTool(Name = "configure_analog_channels", UseStructuredContent = true)]
    ...
    [McpServerTool(Name = "configure_digital_channels", UseStructuredContent = true)]
    ...
    [McpServerTool(Name = "set_digital_direction", UseStructuredContent = true)]
    ...
    [McpServerTool(Name = "set_digital_output", UseStructuredContent = true)]
    ...
    [McpServerTool(Name = "set_pwm_output", UseStructuredContent = true)]
    ...
    [McpServerTool(Name = "disable_pwm", UseStructuredContent = true)]
    ...
    [McpServerTool(Name = "list_analog_outputs", UseStructuredContent = true)]
    ...
    [McpServerTool(Name = "set_analog_output", UseStructuredContent = true)]
    ...
    [McpServerTool(Name = "latch_analog_outputs", UseStructuredContent = true)]
    ...
    [McpServerTool(Name = "read_analog_output", UseStructuredContent = true)]
    ...
    [McpServerTool(Name = "set_sample_rate", UseStructuredContent = true)]
    ...
    [McpServerTool(Name = "start_sd_logging", UseStructuredContent = true)]
    ...
    [McpServerTool(Name = "stop_sd_logging", UseStructuredContent = true)]
    ...
    [McpServerTool(Name = "list_sd_files", UseStructuredContent = true)]
    ...
    [McpServerTool(Name = "get_sd_storage", UseStructuredContent = true)]
    ...
    [McpServerTool(Name = "download_sd_file", UseStructuredContent = true)]
    ...
    [McpServerTool(Name = "delete_sd_file", UseStructuredContent = true)]
    ...
    [McpServerTool(Name = "read_channel_values", UseStructuredContent = true)]
    ...
    [McpServerTool(Name = "capture_samples", UseStructuredContent = true)]
