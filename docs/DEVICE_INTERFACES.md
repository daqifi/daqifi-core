...
Connecting, enabling a channel and streaming is a handful of lines — the root README's
[See it in 30 seconds](../README.md#see-it-in-30-seconds) is the copy-paste version, and it
is kept current there rather than in two places.

This document is the layer under it: the interfaces themselves, discovery beyond one call,
reconnect, feature gating, thread-safety rules, and diagnostics.
